...
public class GestionPrestamoViewController {
    ...
    private void initDataBinding() {
        ...
        tc_FechaEntrega.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().fechaPrestamo().toString()));
    ...
    private PrestamoDto crearPrestamoDto() {
        return new PrestamoDto(
                ...
                cb_ClienteAsociado.getSelectionModel().getSelectedItem(), EstadoPrestamo.PENDIENTE);
    }

    private PrestamoDto crearPrestamoDto(EstadoPrestamo estadoPrestamo) {
        return new PrestamoDto(
                txt_NumeroPrestamo.getText(),
                txt_Descripcion.getText(),
                datePicker_FechaPrestamo.getValue(),
                datePicker_FechaEntrega.getValue(),
                cb_EmpleadoAsociado.getSelectionModel().getSelectedItem(),
                cb_ClienteAsociado.getSelectionModel().getSelectedItem(), estadoPrestamo);
    }
    ...
    private void actualizarPrestamo() {
        if (prestamoSeleccionado != null) {
            if (verificarCampos()) {
                PrestamoDto prestamoDto = crearPrestamoDto(prestamoSeleccionado.estadoPrestamo());
